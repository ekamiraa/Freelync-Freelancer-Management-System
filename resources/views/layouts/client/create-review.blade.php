...
<div class="page-title dark-background"
    style="background-image: url('{{ asset('assets/img/reviews/review-2.jpg') }}');">
...
<section id="general-form" class="general-form section">
    ...
    <div class="container" data-aos="fade-up" data-aos-delay="100">
        <form action="{{route('client.create-review.store', $project->id)}}" method="post" class="php-email-form"
            ...
            <div class="row gy-4">
                ...
                <div class="col-md-12">
                    ...
                    <!-- <input type="text" class="form-control" name="review" placeholder="Your Review" required> -->
