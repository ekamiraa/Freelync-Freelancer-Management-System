<header id="header" class="header d-flex align-items-center fixed-top">
    <div class="container-fluid container-xl position-relative d-flex align-items-center justify-content-between">
        ...
        <nav id="navmenu" class="navmenu">
            <ul>
                <li><a href="{{ route('dashboard.client') }}"
                        class="{{ Route::is('dashboard.client') ? 'active' : '' }}">Home</a>
                </li>
                <li><a href="{{ route('client.my-projects') }}"
                        class="{{ Route::is('client.my-projects') || Route::is('task') ? 'active' : '' }}">My
                        Project</a></li>
                <li><a href="{{ route('review') }}" class="{{ Route::is('review') ? 'active' : '' }}">Review</a></li>
                <li><a href="{{ route('client.waiting-approval-project') }}"
                        class="{{ Route::is('client.waiting-approval-project') ? 'active' : '' }}">Application</a></li>
